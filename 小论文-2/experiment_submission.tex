...
MIKU 在窄路多障碍中提升 \RandNarrowMikuVsBZeroSuccessDiff 个百分点，在延迟横穿中提升 \RandDelayedMikuVsBZeroSuccessDiff 个百分点。预测含噪场景到达率变化为 \RandNoiseMikuVsBZeroSuccessDiff 个百分点（下降），碰撞率配对差为 \RandNoiseMikuVsBZeroCollisionDiff 个百分点（下降），并伴随高降级停止率，体现安全--可达性权衡。
