...
struct MikuPathBoundsConfig {
    bool enable_dynamic_projection = true;
    bool enable_threat_buffer = true;
    bool enable_grouping = true;
    bool enable_max_gap = true;
    double threat_buffer_min = 0.10;
    double threat_buffer_max = 0.40;
    double ttc_critical = 2.0;
    double ttc_max = 7.0;
    double interaction_distance = 10.0;
    double velocity_limit = 12.0;
};
...
public:
    ...
    static bool GetBoundaryFromMikuObstacles(
            const ReferenceLineInfo& reference_line_info,
            const SLState& init_sl_state,
     ...
     */
    static bool ComputeSLBoundaryIntersection(
    ...
    static bool GetBoundaryFromRoad(
            const ReferenceLineInfo& reference_line_info,
            const SLState& init_sl_state,
            PathBoundary* const path_bound);
     ...
     * @return
     */
    static bool ExtendBoundaryByADC(
            const ReferenceLineInfo& reference_line_info,
            const SLState& init_sl_state,
