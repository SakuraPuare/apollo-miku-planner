...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.82\textheight}{\input{../图片/fig_problem_contrast}}
...
\begin{columns}[T,onlytextwidth]
  \column{0.6\textwidth}
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.82\textheight}{\input{../图片/fig_three_problems_a}}
...
\begin{columns}[T,onlytextwidth]
  \column{0.6\textwidth}
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.82\textheight}{\input{../图片/fig_three_problems_b}}
  \column{0.38\textwidth}
  \small
  \textbf{现象}
  \begin{itemize}\setlength\itemsep{3pt}
...
\begin{columns}[T,onlytextwidth]
  \column{0.6\textwidth}
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.82\textheight}{\input{../图片/fig_three_problems_c}}
  \column{0.38\textwidth}
  \small
  \textbf{现象}
  \begin{itemize}\setlength\itemsep{3pt}
...
\begin{columns}[T,onlytextwidth]
  \column{0.6\textwidth}
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.82\textheight}{\input{../图片/fig_algorithm_flow}}
  \column{0.38\textwidth}
  \small
  \textbf{设计原则}
  \begin{itemize}\setlength\itemsep{3pt}
...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.6\textheight}{\input{../图片/fig_safety_margin_compression_a}}\\[2pt]
  {\footnotesize (a) 差异化$\delta_i$：低威胁路锥缩小缓冲}
  \column{0.48\textwidth}
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.6\textheight}{\input{../图片/fig_safety_margin_compression_b}}\\[2pt]
...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.78\textheight}{\input{../图片/fig_max_gap_theorem}}
...
\begin{columns}[T,onlytextwidth]
  \column{0.48\textwidth}
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.6\textheight}{\input{../图片/fig_corridor_a}}\\[2pt]
  {\footnotesize (a) Baseline ST：独立障碍物边界}
  \column{0.48\textwidth}
  \centering
  \adjustbox{max width=\linewidth, max totalheight=0.6\textheight}{\input{../图片/fig_corridor_b}}\\[2pt]
...
\begin{center}
  \resizebox{0.38\paperwidth}{!}{\input{../图片/fig_exp_04_dense_construction_sl_a}}\\[-3pt]
...
\begin{center}
  \resizebox{0.50\paperwidth}{!}{\input{../图片/fig_exp_01_crossing_ped_sl_a}}\\[-3pt]
  {\footnotesize (a) Baseline：路径阶段行人不可见}\\[1pt]
  \resizebox{0.50\paperwidth}{!}{\input{../图片/fig_exp_01_crossing_ped_sl_b}}\\[-3pt]
...
\begin{frame}{总结与展望}
\centering
\adjustbox{max width=\linewidth, max totalheight=0.88\textheight}{\input{../图片/fig_contribution_summary}}
\end{frame}
