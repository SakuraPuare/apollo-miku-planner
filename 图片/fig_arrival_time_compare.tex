...
% 二阶残差 = 3.13 - 2.91 ≈ 0.22 s
\draw[<->, thick, lightorange!80!black] (axis cs:20,2.91) -- (axis cs:20,3.13);
\node[lightorange!80!black, font=\footnotesize, anchor=west] at (axis cs:20.3,3.02) {二阶残差 ${\approx}\,0.22$ s};
...
\addplot[deeppink, mark=*, mark size=2pt, only marks] coordinates {(20,2.91)};

\node[deepblue, font=\scriptsize, anchor=south] at (axis cs:20,4.08) {$\tau_0{=}4.0$};
\node[deeppink, font=\scriptsize, anchor=north] at (axis cs:20,2.83) {$\tau{=}2.91$};
