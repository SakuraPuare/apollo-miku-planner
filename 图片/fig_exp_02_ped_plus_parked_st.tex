% 场景02 ST 平面 Baseline vs GTOC 对比
...
\addplot[name path=stlo_gtoc_0, draw=none, forget plot]
    table[col sep=comma, x=t, y=s_lo, discard if not2={mode}{gtoc}{obs_name}{行人}] {\datapath st_bounds.csv};
\addplot[name path=sthi_gtoc_0, draw=none, forget plot]
    table[col sep=comma, x=t, y=s_hi, discard if not2={mode}{gtoc}{obs_name}{行人}] {\datapath st_bounds.csv};
