...
% 场景06 SL 平面 Baseline vs MIKU 对比（上下排，每子图占满 \textwidth）
...
% 障碍物 停车
\fill[dangerred!70, draw=dangerred, thick] (axis cs:20.000,1.100) rectangle (axis cs:24.000,2.100);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:22.000,2.400) {停车};
