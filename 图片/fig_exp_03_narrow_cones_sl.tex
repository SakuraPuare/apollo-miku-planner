...
\addlegendimage{dangerred, thick, dashed}\addlegendentry{Trim @ $s$=16.0\,m}
\draw[dangerred, thick, dashed] (axis cs:16.000,-2.2) -- (axis cs:16.000,2.2);
\node[dangerred, font=\Large\bfseries, inner sep=0pt] at (axis cs:16.000,0.000) {$\times$};
% 障碍物 水马L1
\fill[dangerred!70, draw=dangerred, thick] (axis cs:19.600,1.350) rectangle (axis cs:20.400,1.750);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:20.000,2.050) {水马L1};
% 障碍物 水马L2
\fill[dangerred!70, draw=dangerred, thick] (axis cs:29.600,1.350) rectangle (axis cs:30.400,1.750);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:30.000,2.050) {水马L2};
% 障碍物 水马L3
\fill[dangerred!70, draw=dangerred, thick] (axis cs:39.600,1.350) rectangle (axis cs:40.400,1.750);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:40.000,2.050) {水马L3};
% 障碍物 锥R1
