...
% 障碍物 锥L1
\fill[dangerred!70, draw=dangerred, thick] (axis cs:19.750,1.275) rectangle (axis cs:20.250,1.425);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:20.000,1.725) {锥L1};
% 障碍物 锥L2
\fill[dangerred!70, draw=dangerred, thick] (axis cs:29.750,1.275) rectangle (axis cs:30.250,1.425);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:30.000,1.725) {锥L2};
% 障碍物 锥L3
\fill[dangerred!70, draw=dangerred, thick] (axis cs:39.750,1.275) rectangle (axis cs:40.250,1.425);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:40.000,1.725) {锥L3};
% 障碍物 锥R1
