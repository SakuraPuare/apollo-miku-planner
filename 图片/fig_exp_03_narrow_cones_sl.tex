% 场景03 SL 平面 Baseline vs MIKU 对比（上下排，每子图占满 \textwidth）
...
\addplot[name path=lmin_baseline, draw=vibrantorange, thin, dashed, forget plot, unbounded coords=jump, restrict x to domain=0:16.000, ]
    table[col sep=comma, x=s, y=l_min, discard if not={mode}{baseline}] {\datapath sl.csv};
\addplot[name path=lmax_baseline, draw=vibrantorange, thin, dashed, forget plot, unbounded coords=jump, restrict x to domain=0:16.000, ]
...
\addplot[deepblue, line width=2pt, unbounded coords=jump, restrict x to domain=0:16.000] table[col sep=comma, x=s, y=l_path, discard if not={mode}{baseline}] {\datapath sl.csv};
\addlegendentry{Baseline}
\addlegendimage{red, thick, dashed}\addlegendentry{Trim @ $s$=16.0\,m}
\draw[red, thick, dashed] (axis cs:16.000,-2.2) -- (axis cs:16.000,2.2);
\node[red, font=\Large\bfseries, inner sep=0pt] at (axis cs:16.000,0.000) {$\times$};
% 障碍物 锥L1
\fill[dangerred!70, draw=dangerred, thick] (axis cs:19.750,1.125) rectangle (axis cs:20.250,1.275);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:20.000,1.575) {锥L1};
% 障碍物 锥L2
\fill[dangerred!70, draw=dangerred, thick] (axis cs:29.750,1.125) rectangle (axis cs:30.250,1.275);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:30.000,1.575) {锥L2};
% 障碍物 锥L3
\fill[dangerred!70, draw=dangerred, thick] (axis cs:39.750,1.125) rectangle (axis cs:40.250,1.275);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:40.000,1.575) {锥L3};
% 障碍物 锥R1
\fill[dangerred!70, draw=dangerred, thick] (axis cs:19.750,-1.275) rectangle (axis cs:20.250,-1.125);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:20.000,-0.825) {锥R1};
% 障碍物 锥R2
\fill[dangerred!70, draw=dangerred, thick] (axis cs:29.750,-1.275) rectangle (axis cs:30.250,-1.125);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:30.000,-0.825) {锥R2};
% 障碍物 锥R3
\fill[dangerred!70, draw=dangerred, thick] (axis cs:39.750,-1.275) rectangle (axis cs:40.250,-1.125);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:40.000,-0.825) {锥R3};
