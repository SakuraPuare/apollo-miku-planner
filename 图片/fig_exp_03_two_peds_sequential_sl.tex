% 场景03 SL 平面 Baseline vs GTOC 对比（上下排，每子图占满 \textwidth）
...
\begin{axis}[
    ...
    xmin=0, xmax=35.0, ymin=-2.2, ymax=2.2,
...
\addplot[fill=bglight, draw=none, forget plot, on layer=axis background] coordinates {(0,-1.875) (35.0,-1.875) (35.0,1.875) (0,1.875)} \closedcycle;

\draw[black!55, semithick] (axis cs:0,-1.875) -- (axis cs:35.0,-1.875);
\draw[black!55, semithick] (axis cs:0,1.875) -- (axis cs:35.0,1.875);
\draw[black!30, dashed, thin] (axis cs:0,0) -- (axis cs:35.0,0);
...
% 障碍物 行人A
\fill[dangerred, opacity=0.95] (axis cs:13.000,-0.400) circle [radius=5pt];
\fill[dangerred, opacity=0.55] (axis cs:13.000,0.260) circle [radius=5pt];
\fill[dangerred, opacity=0.35] (axis cs:13.000,0.920) circle [radius=5pt];
\fill[dangerred, opacity=0.20] (axis cs:13.000,1.600) circle [radius=5pt];
\draw[->, dangerred, very thick, opacity=0.85] (axis cs:13.000,-0.400) -- (axis cs:13.000,1.600);
\node[anchor=south, font=\tiny, color=dangerred] at (axis cs:13.000,0.350) {行人A $v=(+0.0,+1.0)$};
% 障碍物 行人B
\fill[dangerred, opacity=0.95] (axis cs:26.000,-0.400) circle [radius=5pt];
\fill[dangerred, opacity=0.55] (axis cs:26.000,0.260) circle [radius=5pt];
\fill[dangerred, opacity=0.35] (axis cs:26.000,0.920) circle [radius=5pt];
\fill[dangerred, opacity=0.20] (axis cs:26.000,1.600) circle [radius=5pt];
\draw[->, dangerred, very thick, opacity=0.85] (axis cs:26.000,-0.400) -- (axis cs:26.000,1.600);
\node[anchor=south, font=\tiny, color=dangerred] at (axis cs:26.000,0.350) {行人B $v=(+0.0,+1.0)$};
