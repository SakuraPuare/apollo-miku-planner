...
\begin{tikzpicture}[scale=0.95, transform shape]
  ...
  \node[font=\scriptsize, deepblue] at (1.95,0.55) {$v_{ego}{=}8$ m/s};
  ...
  \node[font=\scriptsize, dangerred!70!black] at (5.5,1.05) {$v_{lat}{=}1.2$ m/s};

  % 距离标尺
  \draw[<->, thin, gray] (1.4,-0.75) -- (5.7,-0.75);
  \node[font=\scriptsize, gray] at (3.55,-0.6) {$s_{\text{rel}}{=}10$ m};
