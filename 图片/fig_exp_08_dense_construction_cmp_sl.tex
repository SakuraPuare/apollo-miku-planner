...
% 场景08 SL 平面 Baseline vs MIKU 对比（上下排，每子图占满 \textwidth）
...
% 障碍物 水马M1
\fill[dangerred!70, draw=dangerred, thick] (axis cs:27.000,1.375) rectangle (axis cs:31.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:29.000,2.675) {水马M1};
% 障碍物 水马M2
\fill[dangerred!70, draw=dangerred, thick] (axis cs:31.000,1.375) rectangle (axis cs:35.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:33.000,2.675) {水马M2};
% 障碍物 水马M3
\fill[dangerred!70, draw=dangerred, thick] (axis cs:35.000,1.375) rectangle (axis cs:39.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:37.000,2.675) {水马M3};
% 障碍物 水马M4
\fill[dangerred!70, draw=dangerred, thick] (axis cs:39.000,1.375) rectangle (axis cs:43.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:41.000,2.675) {水马M4};
% 障碍物 水马M5
\fill[dangerred!70, draw=dangerred, thick] (axis cs:43.000,1.375) rectangle (axis cs:47.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:45.000,2.675) {水马M5};
% 障碍物 水马M6
\fill[dangerred!70, draw=dangerred, thick] (axis cs:47.000,1.375) rectangle (axis cs:51.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:49.000,2.675) {水马M6};
% 障碍物 水马M7
\fill[dangerred!70, draw=dangerred, thick] (axis cs:51.000,1.375) rectangle (axis cs:55.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:53.000,2.675) {水马M7};
% 障碍物 水马M8
\fill[dangerred!70, draw=dangerred, thick] (axis cs:55.000,1.375) rectangle (axis cs:59.000,2.375);
\node[anchor=south, font=\tiny, color=dangerred!80!black] at (axis cs:57.000,2.675) {水马M8};
% 障碍物 锥X1
