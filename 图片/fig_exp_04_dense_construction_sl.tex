% 场景04 SL 平面 Baseline vs GTOC 对比（上下排，每子图占满 \textwidth）
...
\addlegendimage{red, thick, dashed}\addlegendentry{Trim @ $s$=23.0\,m}
\draw[red, thick, dashed] (axis cs:23.000,-3.9) -- (axis cs:23.000,3.9);
\node[red, font=\Large\bfseries, inner sep=0pt] at (axis cs:23.000,3.336) {$\times$};
% 障碍物 锥E1
