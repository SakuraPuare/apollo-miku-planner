...
\begin{center}
{\Large\bfseries 湖北文理学院毕业设计（论文）指导记录表}
\end{center}
...
\vspace{30pt}
\hfill 指导教师签名：\includegraphics[height=1.2cm]{../签名/孙成娇.jpeg}\hspace{1cm}
\vspace{4pt}
} \\
\hline
\multicolumn{4}{|p{15.46cm}|}{
